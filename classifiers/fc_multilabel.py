...
#model_m.add(Reshape((300,102), input_shape=(300,)))
#model_m.add(Flatten())
model_m.add(Dense(256, input_dim=300, kernel_initializer='he_uniform', activation='relu'))
#model_m.add(Dense(256,activation='relu'))
model_m.add(Dense(128, activation='relu'))
model_m.add(Dense(102, activation='sigmoid'))
...
model_m.save("FIGER_cat_w2v_FC_model_multilabel_200.h5")
print("Saved model to disk")

f = open("FIGER_cat_w2v_FC_model_multilabel_200.txt", "a")
